...
@property (nonatomic, assign) int shieldCount;
...
-(void)checkShieldCount {
    
    
    if(_shieldCount >= 10) {
            
            [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"shieldCT"];
            [[NSUserDefaults standardUserDefaults] synchronize];
            [self reportAchievementIdentifier:@"shieldID" percentComplete:100];
