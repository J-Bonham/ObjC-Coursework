...
-(void)checkLvl2Completion {
        
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"lvl2"];
        [[NSUserDefaults standardUserDefaults] synchronize];
        [self reportAchievementIdentifier:@"level2ID" percentComplete:100];
