...
-(void)didMoveToView:(SKView *)view {
    ...
    NSData *localLBData = [[NSUserDefaults standardUserDefaults] objectForKey:@"leaderboard"];
    ...
    playRepair = [SKAction playSoundFileNamed:@"repair.mp3" waitForCompletion:YES];
    playshield = [SKAction playSoundFileNamed:@"shieldSound.mp3" waitForCompletion:YES];
...
- (void)player:(SKSpriteNode *)player didCollideWithShip:(SKSpriteNode *)asteroidHit {
    ...
    if (shield.alpha != 0){
        ...
        if (_playerHull == 0) {
            ...
            [[NSUserDefaults standardUserDefaults] setInteger:_scoreValue forKey:@"leaderboard"];
            ...
            [[NSUserDefaults standardUserDefaults] setObject:lbData forKey:@"leaderboard"];
            [[NSUserDefaults standardUserDefaults] synchronize];
