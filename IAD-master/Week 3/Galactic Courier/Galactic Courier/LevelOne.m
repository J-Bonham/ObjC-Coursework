...
- (void)player:(SKSpriteNode *)player didCollideWithShip:(SKSpriteNode *)asteroidHit {
    ...
    if (_playerHull == 0) {
        ...
        UIAlertView *nameAlert = [[UIAlertView alloc] initWithTitle:@"Local Leaderboard" message:@"Enter Your Name For Leaderboard" delegate:self cancelButtonTitle:@"Add" otherButtonTitles: nil];
